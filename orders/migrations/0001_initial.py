# -*- coding: utf-8 -*-
# Generated by Django 1.11.25 on 2019-11-12 21:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('created', 'Создана'), ('paid', 'Оплачена'), ('shipped', 'Отправлена'), ('refunded', 'Возвращена')], default='created', max_length=120)),
