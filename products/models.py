...
from KAproject.utils import unique_slug_generator
...
def upload_image_path(instance, filename):
    print(instance)
    print(filename)
    new_filename = random.randint(1, 3925483217)
...
class Product(models.Model):
    ...
    price = models.DecimalField(decimal_places=2, max_digits=20, default=39.99, verbose_name='Цена')
